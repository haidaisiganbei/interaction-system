...
import Position, { PositionInterface } from '../models/Position';
...
export class TouchControlMessage extends ControlMessage {
    public static PAYLOAD_LENGTH = 28 + 1 + 4; //  1字节代表群控还是单控，后面4字节为底层需要填充
    /**
    ...
    public toBuffer(): Buffer {
        ...
        let offset = 0;
        offset = buffer.writeUInt8(0, offset); // 0代表群控，从1开始代表单控
        ...
        offset = buffer.writeUInt32BE(0, offset); // 底层需要填充4字节
